...
#grid(
  ...
  [
    #figure(
      image("../media/start_screen.png", width: 100%),
      caption: [Start screen of the Android app],
    ) <fig-start-screen>
  ],
)
...
#grid(
  ...
  [
    #figure(
      image("../media/obrazovka_polozky.png", width: 80%),
      caption: [Item detail with movement history],
    ) <fig-detail-screen>
  ],
  [
    #figure(
      image("../media/inventory_screen.png", width: 80%),
      caption: [Inventory check mode],
    ) <fig-inventory-screen>
  ],
)
...
The *Beams and Jointers* (_Hranolky a Spárovky_) application is a native Kotlin Android application with the following architecture:
